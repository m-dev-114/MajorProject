...
# ══════════════════════════════════════════════════════════════════════════
st.markdown("""
<div style='background:linear-gradient(135deg,#1e1e2e,#2a2a3e);border:1px solid #444466;
            border-radius:14px;padding:1.4rem 1.8rem;margin-bottom:1.5rem;'>
  <div style='font-size:1.1rem;font-weight:700;color:#4cc9f0;margin-bottom:0.6rem;'>📁 Upload Dataset</div>
  <div style='font-size:0.82rem;color:#aaa;line-height:1.8;'>
    Upload any of the 3 supported datasets below. The dashboard auto-detects columns and runs all models automatically.<br>
    <span style='color:#06d6a0;font-weight:600;'>🟢 agile_dataset_large.csv</span> — 8,000 rows · 37 cols · 8 assignees · Health ~40/100 (at risk) &nbsp;|&nbsp;
    <span style='color:#06d6a0;font-weight:600;'>🟢 agile_dataset_healthy.csv</span> — 8,000 rows · 37 cols · Health ~80/100 (healthy) &nbsp;|&nbsp;
    <span style='color:#ffd166;font-weight:600;'>🟡 agile_dataset.csv</span> — 2,000 rows · 36 cols · no Sprint_Number
  </div>
</div>
""", unsafe_allow_html=True)
